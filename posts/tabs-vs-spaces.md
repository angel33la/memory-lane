...
date: 2025-11-01
summary: "This blog post explores the arguments for using tabs or spaces for indentation and discusses the implications for team workflows."
layout: post
---

This blog post explores the arguments for both sides and discusses
the implications of this choice in coding practices.

The choice between using tabs or spaces for indentation is a
long-standing and often passionate debate among programmers (known
as a "holy war" in the developer community).
